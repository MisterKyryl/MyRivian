(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const cloudImage360 = document.querySelector(".cloudimage-360");
        const headerMain = document.querySelector(".header-main");
        if (cloudImage360 && headerMain) cloudImage360.addEventListener("imageChanged", (function(event) {
            const currentIndex = event.detail.index;
            if (currentIndex === 137) headerMain.classList.add("_active-main"); else headerMain.classList.remove("_active-main");
        }));
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        function updateBodyClass() {
            ...
            if (activeIndex >= 138 && activeIndex <= 278) {
